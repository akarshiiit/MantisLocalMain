...
return ( <div className="min-h-screen bg-[#F3F5F7] text-[#111315]">
  ...
  <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 py-12 lg:grid-cols-[1fr_1fr]">
    ...
    <div className="flex flex-col gap-8">
      ...
      {/* Product Info Card */}
      <div className="overflow-hidden rounded-3xl border border-[#60758A]/10 bg-white shadow-soft">
        ...
        <div className="p-8">
          ...
          <p className="mt-6 text-[15px] leading-relaxed text-[#60758A]">
            Ask the assistant any questions about maintenance, troubleshooting, or parts. It uses official manuals and service documentation to give you precise answers.
          </p>
      ...
      {/* Resources Card */}
      <div className="rounded-3xl border border-[#60758A]/10 bg-white p-8 shadow-soft">
        ...
        <div className="mt-6 flex flex-col gap-3">
          ...
          <div className="flex items-center justify-between rounded-2xl bg-[#F3F5F7]/50 p-4 transition hover:bg-[#F3F5F7]">
            ...
            <button className="rounded-xl bg-white border border-[#60758A]/20 px-5 py-2 text-[13px] font-medium text-[#111315] shadow-soft-sm transition hover:bg-[#F3F5F7]">
              Open
            </button>
          </div>
